...
if __name__ == "__main__":
    ...
    parser.add_argument("--train", type = str, default = 'wine_1_50.csv', help = "Training dataset")
    ...
    param_grid = [
        {'degree': [1, 2, 3, 4, 5], 'gamma': [0.0001, 0.001, 0.01, 0.1, 1], 'coef0': [0, 0.0001, 0.001, 0.01, 0.1, 1], 'C': [0.0001, 0.001, 0.01, 0.1, 1, 10, 100]}
      ]

    model = svm.SVC(kernel="poly", random_state=1)
    ...
    print("---train")
    model = svm.SVC(kernel="poly", **grid_search.best_params_, random_state=1) # this line should be changed with best parameters set up
    ...
    joblib.dump(model, "SVM-p50_model.sav")
